...
class GameUI {
  ...
  displayQuestion() {
    ...
    // Display target pick
    this.elements.targetName.textContent = question.targetPick.name;
    if (question.targetPick.image) {
      this.elements.targetImage.innerHTML = `<img src="${question.targetPick.image}" alt="${question.targetPick.name}">`;
    } else {
